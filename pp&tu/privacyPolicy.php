<?php include 'header.html'?>
    ...
    <button class="btn btn-danger">s</button>
        ...
        <p>Welcome to DR DHEFIN SHOES, your privacy is important to us. This privacy policy document outlines the types of personal information that is received and collected by DR DHEFIN SHOES and how it is used.</p>
